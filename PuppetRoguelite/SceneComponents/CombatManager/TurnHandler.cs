...
namespace PuppetRoguelite.SceneComponents.CombatManager
{
    public class TurnHandler
    {
        ...
        public void BeginTurn()
        {
            ...
            _camera = Core.Scene.Camera.GetComponent<DeadzoneFollowCamera>();
            _camera.SetFollowTarget(_playerSimEntity);

            //create menu entity
            Debug.Log("creating turn menu entity");
            _turnMenuEntity = Core.Scene.CreateEntity("turn-menu");
