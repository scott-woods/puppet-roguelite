...
namespace PuppetRoguelite.Components.Characters.Player.PlayerActions.Attacks
{
    ...
    public class DashAttack : PlayerAction
    {
        ...
        public override void Prepare()
        {
            ...
            var dashTexture = Core.Scene.Content.LoadTexture(Content.Textures.Characters.Player.Hooded_knight_attack);
        ...
        public override void Update()
        {
            ...
            if (State == PlayerActionState.Preparing)
            {
                ...
                _direction = Core.Scene.Camera.MouseToWorldPoint() - InitialPosition;
