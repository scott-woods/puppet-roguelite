...
namespace PuppetRoguelite.Components.Objects
{
    public class Dollah : Component, IUpdatable
    {
        ...
        public override void Initialize()
        {
            ...
            var texture = Entity.Scene.Content.LoadTexture(Content.Textures.Tilesets.Dungeon_prison_props);
        ...
        public void Update()
        {
            ...
            else if (_isMovingToPlayer)
            {
                ...
                if (colliders.Count > 0)
                {
                    ...
                    Game1.AudioManager.PlaySound(Content.Audio.Sounds.Dollah_pickup);
